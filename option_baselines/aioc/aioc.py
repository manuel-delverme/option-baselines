...
class AIOC(OnPolicyAlgorithm):
    ...
    def _setup_model(self) -> None:
        ...
        self.policy = InterestOptionNet(policies, meta_policy, terminations, self.lr_schedule, num_agents=self.n_envs, **self.policy_kwargs)


class InterestOptionNet(torch.nn.Module):
    def __init__(
            self,
            policies: torch.nn.ModuleList,
            meta_policy: torch.nn.Module,
            meta_interest_function: torch.nn.Module,
        ...
        super(InterestOptionNet, self).__init__()
        self.policies = policies
        self.meta_policy = meta_policy
        self.meta_interest_function = meta_interest_function
        ...
        del self.meta_interest_function.optimizer
    ...
    def set_training_mode(self, training_mode):
        ...
        self.meta_interest_function.train(training_mode)
